...
import { ContactList, ContactListParam } from '@/api/get-contact-list/get-contact-list.types';
...
export const contactListKeys = {
  ...
  list: (params?: ContactListParam) => [...contactListKeys.all, 'list', params] as const,
};

type UseContactListOptions = Omit<
  UseQueryOptions<
    ApiResponse<ContactList>,
    ApiError<ContactListParam>,
    ApiResponse<ContactList>,
...
export function useContactList(params?: ContactListParam, options?: UseContactListOptions) {
  return useQuery({
